...
**Programming:** Python, JavaScript (ES6+), TypeScript, C, C++, SQL, Bash  
**Web Development:** React, Vite, Tailwind CSS, Flask, FastAPI, Node.js, Django  
**Machine Learning:** FastAI, Scikit-learn, LightGBM, PyTorch, Pandas, NumPy  
**Databases & Cloud:** PostgreSQL, Supabase, Firebase, MySQL, Azure, AWS  
**Tools & Platforms:** Git/GitHub, Docker, Linux, VS Code, Figma, LaTeX, Vercel  
...
### 🏎️ [F1 Race Prediction & Analytics (WIP)](https://github.com/spandan3/f1-project)  
...
- Future roadmap: **FastAPI backend** + **RAG chat assistant** with FAISS/Qdrant  
